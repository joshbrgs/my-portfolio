	...
	return (
		<section className="about">
			<div className="bio-container">
				...
				// ref={ref}
				>
					Most of my experience is in Front End Developement, but I love the whole process of building apps,
					Back Ends, and programs. I graduated from <b>Pittsburgh University</b>, in Pittsburgh Pennsylvania,
					with a BS in Digital Marketing. It was during my undergraduate where I was introduced to the basics
					of scripting languages, and once I graduated I was down the rabbit hole of learning{' '}
				...
				>
					...
					with <b>MongoDB</b> and <b>FireBase</b>. I use WordPress and Shopify as an Eccomerce CMS, and their
					SDK for personalized experiences. I also wireframe and design with <b>AdobeXD</b> and{' '}
				...
				// ref={ref}
				>
					I love learning new tech, and trying new things. The reason I find this industry so interesting is
					because of the endless possibilities and creativity. One growing interest of mine is in the{' '}
